...
def main():
    downloading = jobtracker.query("SELECT * FROM files, download_attempts WHERE download_attempts.status='downloading' AND files.id=download_attempts.download_id")
