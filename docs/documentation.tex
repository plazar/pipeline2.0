...
\begin{description}
    ...
    \item[Step 6] Set up the database. This is done using the script \texttt{bin/create\_database.py}.
...
\begin{figure}
    \centering
    \includegraphics{./figs/ThreadedDownloadFlow.png}
...
\begin{figure}
    \centering
    \includegraphics{./figs/JobFlow.png}
