...
\begin{description}
    ...
    \item[use\_default\_zaplists] A boolean value that determines whether or not to use default zaplist. If False, jobs will be skipped if no MJD-specific zaplist is found. 
\end{description}
